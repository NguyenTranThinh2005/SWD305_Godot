...
const API_BASE = "http://127.0.0.1:5290" # Thay đổi port tương ứng với file launchSettings.json
...
func register(email: String, password: String, grade: int, region: String, avatar: String) -> Dictionary:
	var payload = {
		"email": email,
		"password": password,
		"grade": grade,
